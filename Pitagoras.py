...
class Pitagoras(Scene):
    def construct(self):
        title = Text("Teorema de Pitágoras", color=BLUE).to_corner(UL)
        ...
        text4 = Text("c^2 = a^2 + b^2").scale(.7).move_to(DOWN * 3)
        ...
        final_text = Text("", color=GREEN).scale(2)
